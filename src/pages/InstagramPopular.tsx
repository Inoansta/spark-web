...
import InstagramPopularContainer from '@/domains/Instagram/Popular/components/InstagramPopularContainer';
import PopularSkeleton from '@/domains/Youtube/Popular/skeleton/skeleton';
import { NextPageFooter } from '@/shared/components';

export default function InstagramPopular() {
  return (
    <div>
      <div
        className={
      ...
      >
        <QuerySuspenseBoundary loadingFallback={<PopularSkeleton />}>
          ...
          <div className={'flex  gap-[20px] flex-col mt-[60px] mb-[200px]'}>
            <InstagramPopularContainer />
          </div>
        </QuerySuspenseBoundary>
      </div>

      <NextPageFooter
        nextLocation={'/instagram-strength-weakness'}
        text={'다음'}
