    ...
    return HttpResponse.json(
      {
        비법1: {
          ...
          '실행 방법': [
            "투표를 통한 주제 선정: 다음 영상 주제에 대해 구독자들의 투표를 받아보세요. 예를 들어, '아이의 방 꾸미기' 대 '가족 나들이 Vlog' 중에서 선택하게 하면 좋아요.",
            "구독자의 콘텐츠 제안 받기: '다음에는 무슨 영상을 찍어볼까요?'라는 질문을 커뮤니티 탭에 올리고, 구독자들의 의견을 받아보세요.",
            "테마 콘테스트 개최: 예를 들어, '가장 재밌는 가족 게임' 영상을 구독자들이 직접 제안하고, 가장 많은 투표를 받은 아이디어를 실제로 제작해 보세요.",
          ],
          출처: '유튜브 공식 가이드',
        },
        비법2: {
