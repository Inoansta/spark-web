...
interface AvatarProps extends SvgProps {
  avatarHeadFill?: string;
  avatarBodyFill?: string;
}
...
export const Avatar = ({ className, ...props }: AvatarProps) => {
  return (
    <svg
      ...
      {...props}
    >
      <circle cx="30" cy="30" r="30" fill={props.fill ?? '#8D9199'} />
      <path
        ...
        fill={props.avatarHeadFill ?? 'white'}
      />
      <path
        ...
        fill={props.avatarBodyFill ?? 'white'}
      />
    </svg>
  );
};
