...
const items = [
  {
    ...
    content: (
      <ol className={'pl-[5px]'} type="A">
        <li>
          여러분의 채널 정보는 유튜브/인스타그램 API를 통해 실시간으로
          불러오기만 할 뿐, 데이터베이스에는 저장되지 않아요. 필요한 정보를
          불러오는 것 외에 여러분의 데이터를 다른 용도로 사용하지 않으니,
          개인정보 유출에 대한 걱정 없이 안심하고 이용하셔도 됩니다!
        </li>
      </ol>
    ),
  },
  {
    ...
    content: (
      <ol className={'pl-[5px]'} type="A">
        <li>
          여러분의 채널 정보 (팔로워 수, 조회수, 좋아요 수 등 )를 불러와서
          ...
          <ul className={'list-disc pl-[20px]'}>
            <li>
              비법들은 모두 공식 사이트(유튜브 공식 채널, 인스타그램 공식
              블로그)에 나와있는 방법들이기 때문에 신뢰할 수 있어요.
            </li>
            <li>
  ...
  },
  {
    ...
    content: (
      <ol className={'pl-[5px]'} type="A">
        <li>
          팔로워 수 증가, 조회수 상승, 수익 증대 등의 성과를 기대할 수 있어요.
          특히, 유튜브/인스타 알고리즘에 맞춰 채널을 최적화시켜 빠르게 성장할 수
          있는 방법을 알려드리니, 실제로 단기간에 효과를 볼 수도 있어요.
          제공되는 전략은 실제 성공사례를 바탕으로 한 것이기 때문에 여러분의
          채널이 성장하는 데 실질적인 도움이 될 거예요.
        </li>
      </ol>
    ),
  },
