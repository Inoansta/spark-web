import analysis from '@/assets/analysis/analysis.json';
import loadingIcon from '@/assets/analysis/loadingIcon.json';
...
import { AnimationLottie, Spacing, Text } from '@/shared/ui';
    ...
    <main className="bg-line p-[10px]">
      ...
      <ul className="flex flex-col gap-y-5 px-5">
        <li className="flex justify-between items-center px-[15px] py-[5px]">
          ...
          <AnimationLottie animationData={loadingIcon} />
        </li>
      </ul>
      <Spacing size="xsmall" />
    </main>
